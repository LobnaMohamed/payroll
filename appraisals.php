				...
				<!-- <div class="table-responsive row"> -->
					<form class="navbar-form row " role="search" id="searchEmp" method="POST" action="fetch.php"
						...
						<div class="col-sm-6 form-group">
							...
							<div class="col-sm-7">
								<input type="submit" name="upload_appraisalsexcel" value="تحديث البيانات"
					...
					<table id="empData" class="table table-striped table-bordered  table-responsive">
							<thead >
								<tr>
                                    ...
                                    <th>الوظيفة المرقى عليها</th>
                                    <th>مستوى الوظيفة المرقى عليها </th>
									<th> المرتب الأساسى قبل التعديل</th>
                                    <th>آخر تقرير كفاية</th>
                                    <th>نسبة العلاوة</th>
                                    <th>قيمة العلاوة</th>
                                    <th>المرتب الأساسى بعد التعديل</th>
									<th>أجر الربط  المالى قبل التعديل</th>
                                    <th>أجر الربط المالى بعد التعديل</th>
                                    <th>بدل التخصص</th>

								</tr>
							</thead>
						<tbody id="empDatabody">
							<?php getAllAppraisals();?>
						</tbody>
					</table>
