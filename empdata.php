					...
					<div class="modal-body row">
						<form method="POST" id="editEmpForm" name="editEmpForm" action = "fetch.php">
								...
								<div class="tab-content">	
									<div class="tab-pane" id="tab5">
										...
										<div class="form-group col-md-4 col-md-offset-1 ">
											...
											<input type="hidden" id="syndicatecurrentIDValue"  name="syndicatecurrentIDValue">	

											<label for= "syndicatecurrentValueEdit">استحقاق النقابة</label>
											<input type="number" step="any" class="form-control" id="syndicatecurrentValueEdit" name="syndicatecurrentValueEdit">
							...
							<div class="form-group col-md-10 col-md-offset-1">
								<input type="submit" name="UpdateEmp" class="btn btn-success btn-lg btn-block" value="حفــــــظ" >
							</div>
